(function () {
    ...
    angular
        .module('app')
        .controller('ADCalendarController', ADCalendarController);

    ADCalendarController.$inject = ['$scope', '$compile', '$timeout', 'uiCalendarConfig', 'ProjectService', '$uibModal'];

    function ADCalendarController($scope, $compile, $timeout, uiCalendarConfig, ProjectService, $uibModal) {
        ...
        $scope.LoadData = function () {
            vm.loading = true;
            ProjectService.GetADProjectCalendar()
                           .then(function (data) {
